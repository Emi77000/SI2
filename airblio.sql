...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 04 mai 2025 à 05:31
...
INSERT INTO `interventions` (`id`, `reference_demande`, `intitule`, `date_intervention`, `lieu`, `statut`, `importance`, `equipement`, `membre`, `description`, `cout`) VALUES
(1783051, 'D682712', 'Remise à niveau du système de transmission sous-marin', '2024-03-18', 'Base navale, Bâtiment B3, 29200 Brest', 'A venir', 'Moyenne', 'Unité radio étanche, Module de transmission, Antenne marine renforcée', 'C. Durand (Ingénieur Systèmes), L. Bianchi (Technicien Réseau)', 'Mise à jour des composants critiques du système de transmission afin de garantir une communication stable. Les anciens modules ont été inspectés, certains remplacés, puis un calibrage complet a été effectué. L opération est planifiée pour coïncider avec une fenêtre météo favorable.', '27500'),
...
(1783050, 'D682712', 'Vérification des câbles de communication sous-marins', '2024-03-18', 'Base navale, Bâtiment B3, 29200 Brest', 'En cours', 'Moyenne', 'Analyseur de câbles, Testeur de continuité, Module de pression sous-marine', 'A. Morel (Chef de projet), N. Roger (Plongeur technique)', 'Inspection visuelle et électronique des câbles principaux reliant les points de surveillance. Aucun dommage majeur n a été constaté. Des tests d étanchéité et de signal ont été réalisés pour garantir l intégrité du réseau. Intervention menée en coordination avec le service technique local.', '19800'),
(1783049, NULL, 'Maintenance préventive annuelle des équipements de plongée', '2024-03-16', 'Sjöfartsgatan 4, 414 58 Göteborg, Suède', 'Terminée', 'Faible', 'Station de recharge, Valves de secours, Kit d inspection optique', 'S. Bergström (Responsable site), K. Holm (Technicien maintenance)', 'Contrôle de sécurité de tous les équipements de plongée conformément aux normes en vigueur. Nettoyage, tests de pression, remplacement des pièces usées. Rapport transmis à la direction technique pour archivage. Aucune anomalie critique signalée.', '22400');
...
(1, 'Inspection des câbles sous-marins', 'Paris', 48.8566, 2.3522, '2025-05-10', 'en cours', 'Emi, Naïla', 'ROV, Sonar'),
(2, 'Maintenance de sonar', 'Londres', 51.5074, -0.1278, '2025-05-20', 'prévu', 'Gabrielle, Sabana', 'Sonar'),
