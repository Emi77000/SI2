...
class InterventionFormScreen(Screen):
    def __init__(self, **kwargs):
        ...
        navbar = BoxLayout(size_hint=(1, 0.08), pos_hint={'top': 1})
        ...
        logout = Button(size_hint=(None, 1), width=40, background_normal='logout.png', background_down='logout.png', background_color=(1, 1, 1, 1), border=(0, 0, 0, 0))
    ...
    def open_date_picker(self, instance):
        ...
        def on_validate(_):
            self.date_selected = f"{day_spinner.text} {month_spinner.text} {year_spinner.text}"
            self.date_button.text = self.date_selected
            popup.dismiss()
