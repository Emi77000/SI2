...
class ConnexionScreen(Screen):
    def __init__(self, **kwargs):
        ...
        email_layout = BoxLayout(orientation='vertical', size_hint=(1, None), height=60)
        email_label = Label(text="Email", font_size=16, color=(1, 1, 1, 1))
        self.email_input = TextInput(multiline=False, size_hint=(1, None), height=40)
        email_layout.add_widget(email_label)
        email_layout.add_widget(self.email_input)
        form_box.add_widget(email_layout)

        password_layout = BoxLayout(orientation='vertical', size_hint=(1, None), height=60)
        ...
        btn = Button(text="Se connecter", size_hint=(1, None), height=45,
